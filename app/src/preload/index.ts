...
const api: Api = {
  ...
  imagePresetDelete: (id) => ipcRenderer.invoke("imagegen:deletePreset", id),
  imagePrompt: (phrase, preset, temperature, work) => ipcRenderer.invoke("imagegen:prompt", phrase, preset, temperature, work),
  worksSearch: (query) => ipcRenderer.invoke("works:search", query),
  imageGenerate: (prompt, width, height, allowPaid, style, ownStyle) => ipcRenderer.invoke("imagegen:run", prompt, width, height, allowPaid, style, ownStyle),
